package com.coding.business.house.game.service.impl;
...
public class GameServiceImpl implements GameService {
	...
	public GameBoard setupGameBoard(int numberOfCells, int initialMoney) {
		...
		List<Player> players = setupPlayers(3);

		List<BoardCell> cells = new ArrayList<>();
		cells.add(new BoardCell(BoardCellType.J));
		cells.add(new BoardCell(BoardCellType.H, new Hotel(1, "aHotel", players.get(0), HotelType.SILVER)));
		cells.add(new BoardCell(BoardCellType.L));
		cells.add(new BoardCell(BoardCellType.H, new Hotel(2, "bHotel", players.get(1), HotelType.SILVER)));
		cells.add(new BoardCell(BoardCellType.E));
		cells.add(new BoardCell(BoardCellType.L));
		cells.add(new BoardCell(BoardCellType.H, new Hotel(3, "cHotel", players.get(2), HotelType.SILVER)));
		cells.add(new BoardCell(BoardCellType.L));
		cells.add(new BoardCell(BoardCellType.H, new Hotel(4, "dHotel", players.get(0), HotelType.SILVER)));
		cells.add(new BoardCell(BoardCellType.J));
